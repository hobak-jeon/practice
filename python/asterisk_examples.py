...
def positional_arguments(i, j, *args: tuple) -> None:
    """2.1. Function providing an example for positional arguments (*args)."""
    print(i, j)  # 1 2
    print(args)  # (3, 4, 5)


def keyword_arguments(q, r, **kwargs: dict) -> None:
    """2.2. Function providing an example for keyword arguments (**kwargs)."""
    print(q, r)
    print(kwargs)


def keyword_only_arguments(m, n, *, o, p=10) -> None:
...
def pre_process(**headers: dict[str, str]) -> None:
